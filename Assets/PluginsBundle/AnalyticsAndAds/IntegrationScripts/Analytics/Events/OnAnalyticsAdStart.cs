...
{
    public struct OnAnalyticsAdStart : EventManager.Event, IAnalyticsEvent
    {
        public float sessionTime;
        public string screen;

        public OnAnalyticsAdStart(string screen)
        {
            this.screen = screen;
            sessionTime = SessionTimeTracker.instance.sessionTime;
        }

        public string eventName { get { return EventStrings.EVENT_AD_START; } }
