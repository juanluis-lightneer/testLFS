...
namespace PlayFab.PfEditor
{
    ...
    public static partial class PlayFabEditorHelper
    {
        ...
        public static string EDEX_ROOT = Application.dataPath + "/FakeLaunchPlugins/PlayFabEditorExtensions/Editor";
        ...
        public static string DEFAULT_SDK_LOCATION = "Assets/FakeLaunchPlugins/PlayFabSdk";
        ...
        private static GUISkin GetUiStyle()
        {
            ...
            {
                var loadPath = eachPath.Substring(eachPath.LastIndexOf("Assets/FakeLaunchPlugins/"));
